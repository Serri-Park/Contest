...
<div style="margin: 0% 10%">
	...
	<section>
		<form id="registerForm" method="post">
			...
			<input type="hidden" name="r_id" value="${r_id.r_id}">
			<input class="form-control" type="hidden" name="t_id" id="t_id" value="${t_id}" readonly> 
 		 <input class="form-control" type="hidden" name="c_id" id="c_id" value="${contest.c_id}" readonly> 
			...
			<div class="contest-write">
				<ul class="write-list">
					...
					<li>
						...
						<textarea class="form-control" id="w_content" name="w_content"></textarea>
					</li>
					...
					<li style="margin-top:25px;">
						...
						<span class="ipt">
							<input class="fileSelect" type="file" name="photo" multiple/>		
						</span>
					</li>
